...
*/
    ...
    let interestPlusOne = 1 + monthlyInterestRate
    let monthlyRate = principal * (monthlyInterestRate * (Math.pow(interestPlusOne, periods)) / (Math.pow(interestPlusOne, periods) - 1));
